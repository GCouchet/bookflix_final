    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expired_Card', creditcards.models.CardExpiryField(null=True, verbose_name='Vencimiento')),
                ...
                ('suspendida', models.DateField(blank=True, null=True, verbose_name='Vencimiento de la membresía')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('subscription', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Membresia')),
